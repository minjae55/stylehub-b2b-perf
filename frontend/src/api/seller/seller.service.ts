...
export const sellerService = {
    ...
    getNewSourcingRequests: async (): Promise<SellerSourcingRequest[]> => {
        return await api.get<SellerSourcingRequest[]>("/sourcing-requests/seller", {
    ...
    getQuoteDrafts: async (): Promise<QuoteDraft[]> => {
        return await api.get<QuoteDraft[]>("/quotes/seller", {
            params: {status: "DRAFT"}
        });
    },
    ...
    getNegotiations: async (): Promise<SellerNegotiation[]> => {
        return await api.get<SellerNegotiation[]>("/negotiations/seller", {
            params: {status: "OPEN"}
        });
    },
    ...
    getPendingShipments: async (): Promise<SellerShipment[]> => {
        return await api.get<SellerShipment[]>("/orders/seller", {
    ...
    getTransits: async (): Promise<SellerTransit[]> => {
        return await api.get<SellerTransit[]>("/orders/seller", {
    ...
    getActiveDisputes: async (): Promise<SellerDispute[]> => {
        return await api.get<SellerDispute[]>("/disputes/seller", {
    ...
    getPendingSettlements: async (): Promise<SellerSettlement[]> => {
        return await api.get<SellerSettlement[]>("/settlements/seller", {
            params: {status: "PENDING"}
        });
    }
};