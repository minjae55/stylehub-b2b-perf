...
export const buyerService = {
    ...
    getSourcingRequests: async (): Promise<BuyerSourcing[]> => {
        return await api.get<BuyerSourcing[]>("/sourcing-requests/buyer", {
    ...
    getReceivedQuotes: async (): Promise<BuyerQuote[]> => {
        return await api.get<BuyerQuote[]>("/quotes/buyer", {
    ...
    getNegotiations: async (): Promise<BuyerNegotiation[]> => {
        return await api.get<BuyerNegotiation[]>("/negotiations/buyer", {
            params: {status: "OPEN"}
        });
    },
    ...
    getPendingPayments: async (): Promise<BuyerOrder[]> => {
        return await api.get<BuyerOrder[]>("/orders/buyer", {
    ...
    getActiveDisputes: async (): Promise<BuyerDispute[]> => {
        return await api.get<BuyerDispute[]>("/disputes/buyer", {
    ...
    getUrgentReceipts: async (): Promise<UrgentReceipt[]> => {
        return await api.get<UrgentReceipt[]>("/orders/buyer/urgent-receipts");
    }
};