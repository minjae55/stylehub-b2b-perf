...
import {Ban, Bell, Building2, ChevronRight, Clock, Heart, LogOut, Mail, MapPin, ShieldCheck, User} from "lucide-react";
...
function ProfileCard() {
    ...
    const roleLabel =
        user?.businessRole === "BUYER" ? "구매자" :
            user?.businessRole === "SELLER" ? "판매자" :
                ...
                <nav className="w-52 shrink-0 flex flex-col justify-between min-h-[640px]">
                    ...
                    <div className="pt-4 border-t border-border/60">
                        <button
                            ...
                            className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium text-muted-foreground/70 hover:text-destructive hover:bg-destructive/5 transition-colors"
                        >
                            <LogOut size={13}/>
                            <span>회원 탈퇴하기</span>
                        </button>
