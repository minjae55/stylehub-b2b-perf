        ...
        <header className="mb-6 rounded-xl border border-slate-200 bg-white p-6 shadow-sm md:p-7">
          <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="shrink-0 rounded-lg border border-primary/25 bg-white px-4 py-3 text-sm shadow-sm">
              ...
              <p className="mt-1 font-bold text-slate-950">{requestId ?? "SRC-2024-0142"}</p>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-primary/25 bg-white shadow-sm ring-1 ring-primary/5">
            ...
            <div className="grid grid-cols-2 gap-3 bg-white p-4 md:grid-cols-4">
              <RequestMetric label="카테고리" value="상의" />
              <RequestMetric label="희망 수량" value="200벌 이상" />
              <RequestMetric label="희망 납기" value="7일 이내" />
              <RequestMetric label="희망 단가" value="15,000원 이하" />
            </div>

            <div className="border-t border-slate-200 bg-slate-50/70 px-5 py-4">
              <p className="text-xs font-bold text-slate-600">요청 메모</p>
              <p className="mt-1 text-sm leading-6 text-slate-900">
                린넨 소재 여름 블라우스, 화이트/베이지 컬러 선호. 샘플 확인 후 본 주문 진행 희망.
              </p>
            </div>
          </div>
        </header>
                    ...
                    <div key={itemIndex} className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                      ...
                      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(event) =>
                              updateQuoteItem(itemIndex, "unitPrice", event.target.value)
                            }
                            min="0"
                            placeholder="0"
                            className={inputClass}
                      ...
                      {optionSummary && (
                        <div className="mt-3 rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-500">
                          옵션 요약 <span className="ml-2 font-semibold text-slate-800">{optionSummary}</span>
                        </div>
                      )}
                    </div>
                  );
