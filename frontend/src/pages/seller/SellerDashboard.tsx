...
<p className="text-xs font-semibold text-foreground">
  {r.totalBudget != null ? `₩{d.totalAmount.toLocaleString()}` : "예산 미정"}
</p>                                    <p className="text-[10px] text-muted-foreground mt-0.5">마감 {r.expiresAt}</p>
                                </div>
                            ...
                            >
                                ...
                                <div className="text-right shrink-0">
                                    ...
                                    <p className="text-[10px] text-muted-foreground mt-0.5">
                                        수수료 {formatCurrency(s.platformFee)} 차감
                                    </p>
                                </div>
                                <ChevronRight size={13}
                                              className="text-muted-foreground/30 group-hover:text-foreground shrink-0 transition-colors"/>
