            ...
            <div className="mb-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                        ...
                        <div className={`font-semibold text-sm ${role === "buyer" ? "text-primary" : "text-foreground"}`}>
                            바이어
                        </div>
                    ...
                    >
                        ...
                        <div className={`font-semibold text-sm ${role === "seller" ? "text-primary" : "text-foreground"}`}>
                            셀러 (공급업체)
                        </div>
            ...
            >
                <div className="mb-5">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        >
                            <User size={18} className={`mb-2 ${memberType === "employee" ? "text-primary" : "text-muted-foreground"}`} />
                            <div className={`font-semibold text-sm ${memberType === "employee" ? "text-primary" : "text-foreground"}`}>
                                직원
                            </div>
                    ...
                    {memberType === "employee" && (
                        <div className="mt-3 bg-amber-50 border border-amber-200 rounded p-3 text-xs text-amber-700 leading-relaxed">
