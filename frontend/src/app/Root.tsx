                ...
                <div className="max-w-[1280px] mx-auto px-4 py-3 flex justify-between">
                    ...
                    <div className="flex-1 max-w-[700px]">
                        <div className="flex border-2 border-primary rounded overflow-hidden">
                            <div
                                className="flex items-center border-r border-border bg-muted px-3 gap-1 cursor-pointer hover:bg-muted/80 transition-colors text-sm text-foreground whitespace-nowrap">
                                전체
                                <ChevronDown size={14}/>
                            </div>
                            <input
