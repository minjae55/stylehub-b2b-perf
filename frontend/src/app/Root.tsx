...
const searchDummyProducts = [
    { id: 1, name: "여성 린넨 블라우스 (7컬러)", supplier: "동대문패션(주)", price: "₩8,900", image: "https://images.unsplash.com/photo-1594938298603-c8148c4b2e8e?w=40&h=40&fit=crop" },
    { id: 2, name: "와이드 슬랙스 스트레이트", supplier: "스타일컴퍼니", price: "₩15,800", image: "https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=40&h=40&fit=crop" },
    { id: 3, name: "플로럴 랩 원피스 (5컬러)", supplier: "트렌드하우스", price: "₩22,000", image: "https://images.unsplash.com/photo-1572804013427-4d7ca7268217?w=40&h=40&fit=crop" },
    { id: 4, name: "울 혼방 오버핏 롱코트", supplier: "프리미엄어패럴", price: "₩58,000", image: "https://images.unsplash.com/photo-1539533018447-63fcce2678e3?w=40&h=40&fit=crop" },
    { id: 5, name: "하이웨이스트 요가 레깅스", supplier: "액티브웨어코리아", price: "₩22,000", image: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=40&h=40&fit=crop" },
    { id: 6, name: "체인 미니 숄더백 (4컬러)", supplier: "패션액세서리몰", price: "₩35,000", image: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=40&h=40&fit=crop" },
    { id: 11, name: "루즈핏 린넨 셔츠 (3컬러)", supplier: "내추럴보이", price: "₩12,000", image: "https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=40&h=40&fit=crop" },
    { id: 12, name: "스트라이프 니트 가디건", supplier: "코지니트", price: "₩19,500", image: "https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=40&h=40&fit=crop" },
    { id: 13, name: "플리츠 미디 스커트 (5컬러)", supplier: "엘레강스모드", price: "₩14,000", image: "https://images.unsplash.com/photo-1583496661160-fb5886a0aaaa?w=40&h=40&fit=crop" },
    { id: 14, name: "오버핏 크롭 후드집업", supplier: "캐주얼하우스", price: "₩22,000", image: "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=40&h=40&fit=crop" },
    { id: 15, name: "실크 새틴 슬립 드레스", supplier: "페미닌스타일", price: "₩28,000", image: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=40&h=40&fit=crop" },
    { id: 16, name: "버킷햇 코튼 (4컬러)", supplier: "패션액세서리몰", price: "₩8,500", image: "https://images.unsplash.com/photo-1520975861611-9272f9c2a78c?w=40&h=40&fit=crop" },
];

// [수정] iconImg, alias 추가
const searchDummyCategories = [
    { id: "tops", name: "상의", icon: "👕", iconImg: "/images/top.png", sub: ["티셔츠/탑", "블라우스/셔츠", "니트/스웨터", "후드/맨투맨"] },
    { id: "bottoms", name: "하의", icon: "👖", iconImg: "/images/bottom.png", alias: ["치마", "바지"], sub: ["팬츠/슬랙스", "스커트", "진/데님", "레깅스"] },
    { id: "dresses", name: "원피스/세트", icon: "👗", iconImg: "/images/one_piece.png", sub: ["원피스", "투피스세트", "점프수트", "코디세트"] },
    { id: "outerwear", name: "아우터", icon: "🧥", iconImg: "/images/outer.png", alias: ["겉옷", "잠바", "코트", "재킷", "가디건"], sub: ["코트", "재킷/점퍼", "가디건", "패딩/베스트"] },
    { id: "innerwear", name: "이너/언더웨어", icon: "🩱", iconImg: "/images/inner.png", alias: ["속옷","잠옷"], sub: ["이너웨어", "브라/속옷", "잠옷/홈웨어"] },
    { id: "sports", name: "스포츠/애슬레저", icon: "🏃", iconImg: "/images/sports.png", alias: ["스포츠","운동복","수영복","요가복","필라테스"], sub: ["스포츠탑", "스포츠레깅스", "트레이닝복", "요가복", "수영복"] },
    { id: "accessories", name: "액세서리", icon: "👜", iconImg: "/images/accessory.png", alias: ["악세서리", "악세사리"], sub: ["가방/백", "스카프/모자", "벨트/양말", "쥬얼리"] },
    { id: "shoes", name: "신발", icon: "👠", iconImg: "/images/shoes.png", alias: ["구두","운동화"], sub: ["스니커즈", "힐/구두", "부츠/앵클부츠", "샌들/슬리퍼"] },
];
                ...
                <div className="max-w-[1280px] mx-auto px-4 py-3 flex justify-between">
                    ...
                    <div className="flex-1 max-w-[700px]">
                                ...
                                {tabDropOpen && (
                                    <div className="absolute left-0 top-full mt-1 bg-white border border-border rounded shadow-lg z-[100] w-28">
                                        {(["product", "category", "brand"] as const).map((tab) => (
                                            <button
                                                key={tab}
                                                onClick={() => { setSearchTab(tab); setTabDropOpen(false); setSearchQuery(""); setResultDropOpen(false); }}
                        ...
                        {resultDropOpen && searchQuery.trim().length > 0 && (
                            <div ref={resultDropRef} className="absolute mt-1 bg-white border border-border rounded shadow-xl z-[100] w-full max-w-[700px] max-h-72 overflow-y-auto">
                                {searchResults.length === 0 ? (
                                    ...
                                    (searchResults as typeof searchDummyProducts).map((p) => (
                                        <Link
                                            key={p.id}
                                            to={`/product/${p.id}`}
                                            onClick={() => { setResultDropOpen(false); setSearchQuery(""); }}
                                        ...
                                        >
                                            ...
                                            <div className="text-primary text-sm font-bold flex-shrink-0">{p.price}</div>
                                        </Link>
                                    ))
                                ) : searchTab === "category" ? (
                                    // [수정] 이모지 → iconImg로 교체
                                    (searchResults as typeof searchDummyCategories).map((c) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="text-xs text-muted-foreground truncate">{c.sub.join(" · ")}</div>
                                            </div>
                                        </Link>
                                    ))
                                ) : (
